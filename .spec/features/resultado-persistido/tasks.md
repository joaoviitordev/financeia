...
## T-001 — Rotas e layout raiz [concluida]
...
## T-002 — Perguntas de dívidas e prazo, com o cálculo [concluida]
...
## T-003 — Armazenamento das simulações [concluida]
...
## T-005 — Conclusão guarda a simulação e navega [concluida]

- Refs: US-004, AC-010
- Arquivos: src/features/onboarding/useOnboarding.ts, src/features/onboarding/Onboarding.tsx, src/routes/SimulationPage.tsx, src/router.tsx, src/App.tsx, src/features/simulations/conclusao.test.tsx
- Modelo: claude-sonnet-5
- Esforço: medio
- Notas: depende de T-001, T-002 e T-003. O hook não conhece rotas: ele guarda ao concluir e devolve o id; quem navega para `/resultado/<id>` é a SimulationPage — o Onboarding só repassa o id do hook para a tela. O router.tsx entrou na lista porque a rota `/resultado/:id` ainda era placeholder: sem trocá-la pela ResultPage de T-004, concluir levaria a uma tela em construção. Atualize também o texto do estado vazio do histórico no App.tsx, que hoje afirma que nada é gravado (Q-001).
